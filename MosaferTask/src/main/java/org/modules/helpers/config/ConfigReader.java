...
public class ConfigReader {
   ...
   *
   * @param key the desired key to get its value
  ...
  public static String readConfigFromCommonProp(String key) {
    File file = new File("src/main/resources/config/common_config.properties");
    return getPropValue(key, file);
  }
